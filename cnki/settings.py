...
MONGO_HOST = 'localhost:27009'
#MONGO_DATABASE = 'TONGJI'
#COLLECTION_NAME = '化学科学与工程学院'

SCHOOL_LIST=['RENMIN','PKU','XMU','SJTU','THU','ZJU','FUDAN','BIT','BNU','BUAA','TONGJI']#'TONGJI',
...
#    'scholar.middlewares.ScholarMiddleware': 543,
